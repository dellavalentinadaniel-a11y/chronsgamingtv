-- 1. Limpiar datos previos (Opcional, para evitar duplicados en pruebas)
TRUNCATE public.comments,
public.articles,
public.media_items CASCADE;
...
VALUES (
    ...
    (
        'a1b2c3d4-0001-4000-a000-000000000002',
    ...
    (
        ...
        'Tides of Tomorrow nos ofrece una oportunidad única de salvar el mundo o, como en mi caso, explorar las consecuencias de nuestras decisiones más egoístas. En un mundo acuático post-apocalíptico, la interacción con otros jugadores a través de nuestras decisiones marca el ritmo de la partida.',
        '/images/articles/tides.png',
        'Análisis',
        'Alberto Lloria',
        8.0,
        '{PC}',
        '{"Ciencia Ficción", Aventura, Indie}'
    ),
    (
        'a1b2c3d4-0001-4000-a000-000000000004',
        ...
        'Pokémon Champions intenta algo nuevo: ser un juego como servicio constante. Para expertos y recién llegados, la experiencia varía. Aunque el sistema de combate se mantiene sólido, la estructura de misiones y pases de batalla puede sentirse algo ajena a lo que esperamos.',
        '/images/articles/pokemon.png',
        'Análisis',
        'Pokémon Company',
        7.0,
        '{"Nintendo Switch"}',
        '{Pokémon, Competitivo, Nintendo}'
    ),
    (
        'a1b2c3d4-0001-4000-a000-000000000005',
        ...
        'Tomodachi Life: Una Vida de Ensueño me ha demostrado que la simplicidad y el humor absurdo siguen teniendo un hueco enorme. Gestionar una isla llena de Miis con personalidades estrambóticas es tan adictivo como lo fue hace una década.',
        '/images/articles/tomodachi.png',
        'Análisis',
        '3DJuegos',
        8.5,
        '{"Nintendo Switch"}',
        '{Simulación, Mii, Nintendo}'
    ),
    (
        ...
        'Hay que aceptar que el World of Warcraft que nos gustaba ya no existe, pero Midnight es lo más cerca que hemos estado de esa gloria. Blizzard ha creado contenido perfecto para los fans, con una narrativa centrada en el Vacío y la protección de Azeroth.',
        '/images/articles/wow.png',
        'Análisis',
        'Blizzard',
        9.0,
        '{PC}',
        '{MMO, Blizzard, Fantasy}'
    ),
    (
        ...
        'Mouse: PI for Hire es como un clásico prohibido de Disney con alma de DOOM. Su apartado artístico de los años 30 es espectacular, pero lo más sorprendente es que su jugabilidad no se queda atrás.',
...
VALUES (
        ...
        'user_001',
        'GamerPro99',
        '¡Increíble análisis! No puedo esperar a jugar la expansión.',
    ...
    (
        ...
        'user_002',
        'Elena_Retro',
        '¿Creen que Mephisto sea más difícil que Lilith?',
        NOW() - INTERVAL '1 hour'
    ),
    (
        'a1b2c3d4-0001-4000-a000-000000000001',
        'user_003',
        'Marc_Z',
        'Gráficamente se ve espectacular.',
        NOW()
    );
